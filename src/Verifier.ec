...
module Verifier_1261 = {
  ...
  proc usr_pointSubAssign(usr_p1 : uint256, usr_p2 : uint256): unit = {
    ...
    tmp69 <@ Primops.gas();
    _15 <- tmp69;
    tmp70 <@ staticcall(_15, _14, _2, _13, usr_p1, _7);
    _16 <- tmp70;
    _17 <- (iszero _16);
    if (_17)
      {
  ...
  proc usr_pointNegate(usr_point : uint256): unit = {
    var _1, _2, usr_pY, tmp88, _3, tmp90, _4, _5, tmp91, _6, _7;
    _1 <- 32;
    _2 <- (usr_point + _1);
  ...
  proc usr_pointAddAssign(usr_p1 : uint256, usr_p2 : uint256): unit = {
    ...
    tmp76 <@ Primops.gas();
    _13 <- tmp76;
    tmp77 <@ staticcall(_13, _12, _2, _11, usr_p1, _7);
    _14 <- tmp77;
    _15 <- (iszero _14);
    if (_15)
      {
  ...
  proc fun_verify(var__offset : uint256, var_length : uint256, var_offset : uint256, var__length : uint256, var_1250_offset : uint256, var_1250_length : uint256): uint256 = {
    var var, zero_bool, tmp434, tmp435, tmp436, tmp437, tmp438, tmp439, tmp440, _1, _2, _3;
  ...
  proc usr_pointMulAndAddIntoDest(usr_point : uint256, usr_s : uint256, usr_dest : uint256): unit = {
    ...
    tmp85 <@ Primops.gas();
    _15 <- tmp85;
    tmp86 <@ staticcall(_15, _14, _2, _13, usr_dest, _6);
    _16 <- tmp86;
  ...
  proc usr_addAssignPermutationLinearisationContributionWithV(usr_dest : uint256, usr_stateOpening0AtZ : uint256, usr_stateOpening1AtZ : uint256, usr_stateOpening2AtZ : uint256, usr_stateOpening3AtZ : uint256): unit = {
    ...
    tmp312 <@ Primops.mload(3680);
    usr_factor <- tmp312;
    tmp313 <@ Primops.mload(3552);
    _1 <- tmp313;
    _2 <- 4064;
    tmp314 <@ Primops.mload(_2);
    _3 <- tmp314;
    tmp315 <@ Primops.mload(3584);
    usr_gamma <- tmp315;
    ...
    tmp319 <@ Primops.mload(3552);
    _20 <- tmp319;
    tmp320 <@ Primops.mload(3680);
    _21 <- tmp320;
    ...
    tmp322 <@ Primops.mload(3552);
    usr_beta <- tmp322;
    tmp323 <@ Primops.mload(3584);
    usr_gamma_1 <- tmp323;
    _24 <- 2752;
  ...
  proc usr_pointAddIntoDest(usr_p1 : uint256, usr_p2 : uint256, usr_dest : uint256): unit = {
    ...
    tmp62 <@ Primops.gas();
    _13 <- tmp62;
    tmp63 <@ staticcall(_13, _12, _2, _11, usr_dest, _7);
    _14 <- tmp63;
    _15 <- (iszero _14);
    if (_15)
      {
  ...
  proc usr_pointMulIntoDest(usr_point : uint256, usr_s : uint256, usr_dest : uint256): unit = {
    ...
    tmp55 <@ Primops.gas();
    _9 <- tmp55;
    tmp56 <@ staticcall(_9, _8, _2, _7, usr_dest, _6);
    _10 <- tmp56;
    _11 <- (iszero _10);
    if (_11)
      {
