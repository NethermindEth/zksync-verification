(* Begin Verifier_1261 *)
require import UInt256 Memory YulPrimops.
...
module Verifier_1261 = {
  ...
  Primops.revert(_2, _7);
    ...
    {
      _16 <- STRING (*pointAddIntoDest: ecAdd failed*);
      _17 <- (W256.of_int 30);
  ...
  proc usr_pointMulAndAddIntoDest(usr_point : uint256, usr_s : uint256, usr_dest : uint256): unit = {
    ...
    _16 <- tmp86;
    usr_success <- (bit_and usr_success _16);
    _17 <- (iszero usr_success);
    if ( bool_of_uint256 _17)
      {
      _18 <- STRING (*pointMulAndAddIntoDest*);
      _19 <- (W256.of_int 22);
  ...
  proc usr_pointNegate(usr_point : uint256): unit = {
    ...
    usr_pY <- tmp88;
    tmp89 <- usr_pY;
    if ( bool_of_uint256 (eq_uint256 tmp89 (W256.of_int 0)))
      {
  ...
  proc usr_addAssignLookupLinearisationContributionWithV(usr_dest : uint256, usr_stateOpening0AtZ : uint256, usr_stateOpening1AtZ : uint256, usr_stateOpening2AtZ : uint256): unit = {
    ...
    _2 <- tmp331;
    usr_factor <- (mulmod usr_factor _2 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    tmp332 <@ Primops.mload((W256.of_int 4096));
    _3 <- tmp332;
    usr_factor <- (mulmod usr_factor _3 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _4 <- (W256.of_int 4000);
    tmp333 <@ Primops.mload(_4);
    _5 <- tmp333;
    usr_factor <- (mulmod usr_factor _5 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _6 <- (W256.of_int 4992);
    ...
    _9 <- tmp335;
    usr_factor <- (mulmod usr_factor _9 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _10 <- (W256.of_int 2944);
    tmp336 <@ Primops.mload(_10);
    _11 <- tmp336;
    usr_factor <- (addmod usr_factor _11 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _12 <- (W256.of_int 3968);
    tmp337 <@ Primops.mload(_12);
    _13 <- tmp337;
    usr_factor <- (addmod usr_factor _13 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_fReconstructed <- usr_stateOpening0AtZ;
    _14 <- (W256.of_int 3840);
    tmp338 <@ Primops.mload(_14);
    usr_eta <- tmp338;
    usr_currentEta <- usr_eta;
    _15 <- (mulmod usr_eta usr_stateOpening1AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_fReconstructed <- (addmod usr_stateOpening0AtZ _15 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_currentEta <- (mulmod usr_eta usr_eta (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _16 <- (mulmod usr_currentEta usr_stateOpening2AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_fReconstructed <- (addmod usr_fReconstructed _16 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_currentEta <- (mulmod usr_currentEta usr_eta (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _17 <- (W256.of_int 3040);
    tmp339 <@ Primops.mload(_17);
    _18 <- tmp339;
    _19 <- (mulmod _18 usr_currentEta (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_fReconstructed <- (addmod usr_fReconstructed _19 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _20 <- (W256.of_int 3008);
    tmp340 <@ Primops.mload(_20);
    _21 <- tmp340;
    usr_fReconstructed <- (mulmod usr_fReconstructed _21 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _22 <- (W256.of_int 3904);
    tmp341 <@ Primops.mload(_22);
    _23 <- tmp341;
    usr_fReconstructed <- (addmod usr_fReconstructed _23 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_fReconstructed (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _24 <- (W256.of_int 3936);
    tmp342 <@ Primops.mload(_24);
    _25 <- tmp342;
    usr_factor <- (mulmod usr_factor _25 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    ...
    _26 <- tmp343;
    usr_factor <- (mulmod usr_factor _26 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    tmp344 <@ Primops.mload((W256.of_int 4096));
    _27 <- tmp344;
    usr_factor <- (mulmod usr_factor _27 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    ...
    _31 <- tmp346;
    _32 <- (mulmod _31 _29 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (addmod usr_factor _32 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    ...
    _36 <- tmp348;
    _37 <- (mulmod _36 _34 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (addmod usr_factor _37 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    tmp349 <@ Primops.mload(_4);
    _38 <- tmp349;
    usr_factor <- (mulmod usr_factor _38 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
  ...
  proc usr_pointSubAssign(usr_p1 : uint256, usr_p2 : uint256): unit = {
    ...
    if ( bool_of_uint256 _17)
      {
      _18 <- STRING (*pointSubAssign: ecAdd failed*);
      _19 <- (W256.of_int 28);
  ...
  proc usr_addAssignPermutationLinearisationContributionWithV(usr_dest : uint256, usr_stateOpening0AtZ : uint256, usr_stateOpening1AtZ : uint256, usr_stateOpening2AtZ : uint256, usr_stateOpening3AtZ : uint256): unit = {
    ...
    usr_gamma <- tmp315;
    _4 <- (addmod (mulmod _3 _1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617)) usr_gamma (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue <- (addmod _4 usr_stateOpening0AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _5 <- (W256.of_int 5);
    _6 <- (mulmod (mulmod _3 _1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617)) _5 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _7 <- (addmod _6 usr_gamma (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue <- (addmod _7 usr_stateOpening1AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _8 <- (W256.of_int 7);
    _9 <- (mulmod (mulmod _3 _1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617)) _8 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _10 <- (addmod _9 usr_gamma (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue <- (addmod _10 usr_stateOpening2AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _11 <- (W256.of_int 10);
    _12 <- (mulmod (mulmod _3 _1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617)) _11 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _13 <- (addmod _12 usr_gamma (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue <- (addmod _13 usr_stateOpening3AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    ...
    _16 <- tmp317;
    _17 <- (mulmod usr_l0AtZ _16 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (addmod usr_factor _17 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    tmp318 <@ Primops.mload((W256.of_int 4000));
    _18 <- tmp318;
    usr_factor <- (mulmod usr_factor _18 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    ...
    _21 <- tmp320;
    usr_factor <- (mulmod _21 _20 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _22 <- (W256.of_int 2848);
    tmp321 <@ Primops.mload(_22);
    _23 <- tmp321;
    usr_factor <- (mulmod usr_factor _23 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    ...
    _25 <- tmp324;
    _26 <- (mulmod _25 usr_beta (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _27 <- (addmod _26 usr_gamma_1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue_1 <- (addmod _27 usr_stateOpening0AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue_1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _28 <- (W256.of_int 2784);
    tmp325 <@ Primops.mload(_28);
    _29 <- tmp325;
    _30 <- (mulmod _29 usr_beta (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _31 <- (addmod _30 usr_gamma_1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue_1 <- (addmod _31 usr_stateOpening1AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue_1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _32 <- (W256.of_int 2816);
    tmp326 <@ Primops.mload(_32);
    _33 <- tmp326;
    _34 <- (mulmod _33 usr_beta (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    _35 <- (addmod _34 usr_gamma_1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_intermediateValue_1 <- (addmod _35 usr_stateOpening2AtZ (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    usr_factor <- (mulmod usr_factor usr_intermediateValue_1 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
    tmp327 <@ Primops.mload((W256.of_int 4000));
    _36 <- tmp327;
    usr_factor <- (mulmod usr_factor _36 (W256.of_int 21888242871839275222246405745257275088548364400416034343698204186575808495617));
  ...
  proc usr_evaluateLagrangePolyOutOfDomain(usr_polyNum : uint256, usr_at : uint256): uint256 = {
    ...
    if ( bool_of_uint256 _7)
      {
      _8 <- STRING (*invalid vanishing polynomial*);
      _9 <- (W256.of_int 28);
  ...
  proc usr_verifyQuotientEvaluation(): unit = {
    ...
    if ( bool_of_uint256 _34)
      {
      _35 <- STRING (*invalid quotient evaluation*);
      _36 <- (W256.of_int 27);
  ...
  proc _BODY(): unit = {
    ...
    if ( bool_of_uint256 _6)
      ...
      selector <- tmp11;
      tmp12 <- selector;
      if ( bool_of_uint256 (tmp12 = (W256.of_int 2279198755)))
        {
        ...
        if ( bool_of_uint256 (tmp12 = (W256.of_int 2659796434)))
          {
  ...
  proc usr_getTranscriptChallenge(usr_numberOfChallenge : uint256): uint256 = {
    ...
    _3 <- (W256.of_int 224);
    _4 <- (shl _3 usr_numberOfChallenge);
    _5 <- (W256.of_int 3460);
    Primops.mstore(_5, _4);
    _6 <- ((shl (W256.of_int 253) (W256.of_int 1)) - (W256.of_int 1));
    _7 <- (W256.of_int 72);
    _8 <- (W256.of_int 3392);
    tmp94 <@ keccak256(_8, _7);
    _9 <- tmp94;
    usr_challenge <- (bit_and _9 _6);
  ...
  proc _BODY(): unit = {
    ...
    _4 <- tmp4;
    tmp5 <@ datasize(STRING (*Verifier_1261_deployed*));
    _5 <- tmp5;
    tmp6 <@ dataoffset(STRING (*Verifier_1261_deployed*));
    _6 <- tmp6;
    codecopy(_4, _6, _5);
    _7 <- _5;
  ...
  proc usr_pointMulIntoDest(usr_point : uint256, usr_s : uint256, usr_dest : uint256): unit = {
    ...
    if ( bool_of_uint256 _11)
      {
      _12 <- STRING (*pointMulIntoDest: ecMul failed*);
      _13 <- (W256.of_int 30);
  ...
  proc usr_finalPairing(): unit = {
    ...
    if ( bool_of_uint256 _48)
      {
      _49 <- STRING (*finalPairing: precompile failure*);
    ...
    if ( bool_of_uint256 _51)
      {
      _52 <- STRING (*finalPairing: pairing failure*);
      _53 <- (W256.of_int 29);
  ...
  proc usr_modexp(usr_value : uint256, usr_power : uint256): uint256 = {
    ...
    if ( bool_of_uint256 _12)
      {
      _13 <- STRING (*modexp precompile failed*);
      _14 <- (W256.of_int 24);
  ...
  proc fun_verify(var__offset : uint256, var_length : uint256, var_offset : uint256, var__length : uint256, var_1250_offset : uint256, var_1250_length : uint256): uint256 = {
    var var1, zero_bool, tmp434, tmp435, tmp436, tmp437, tmp438, tmp439, tmp440, _1, _2, _3;
  ...
  proc usr_pointAddAssign(usr_p1 : uint256, usr_p2 : uint256): unit = {
    ...
    if ( bool_of_uint256 _15)
      {
      _16 <- STRING (*pointAddAssign: ecAdd failed*);
      _17 <- (W256.of_int 28);
  ...
  proc abi_decode_array_uint256_dyn_calldata(offset : uint256, end1 : uint256): (uint256 * uint256) = {
  ...
  proc usr_loadProof(): unit = {
    ...
    _4 <- ((shl (W256.of_int 253) (W256.of_int 1)) - (W256.of_int 1));
    _5 <- (W256.of_int 36);
    _6 <- (usr_offset + _5);
    ...
    usr_isValid <- (bit_and _12 usr_isValid);
    ...
    _23 <- (_22 = _21);
    usr_isValid <- (bit_and _23 usr_isValid);
    ...
    _35 <- (_34 = _33);
    usr_isValid <- (bit_and _35 usr_isValid);
    ...
    _47 <- (_46 = _45);
    usr_isValid <- (bit_and _47 usr_isValid);
    ...
    _59 <- (_58 = _57);
    usr_isValid <- (bit_and _59 usr_isValid);
    ...
    _71 <- (_70 = _69);
    usr_isValid <- (bit_and _71 usr_isValid);
    ...
    _83 <- (_82 = _81);
    usr_isValid <- (bit_and _83 usr_isValid);
    ...
    _95 <- (_94 = _93);
    usr_isValid <- (bit_and _95 usr_isValid);
    ...
    _107 <- (_106 = _105);
    usr_isValid <- (bit_and _107 usr_isValid);
    ...
    _119 <- (_118 = _117);
    usr_isValid <- (bit_and _119 usr_isValid);
    ...
    _131 <- (_130 = _129);
    usr_isValid <- (bit_and _131 usr_isValid);
    ...
    _143 <- (_142 = _141);
    usr_isValid <- (bit_and _143 usr_isValid);
    ...
    _246 <- (_245 = _244);
    usr_isValid <- (bit_and _246 usr_isValid);
    ...
    _258 <- (_257 = _256);
    usr_isValid <- (bit_and _258 usr_isValid);
    ...
    _263 <- tmp146;
    tmp147 <- _263;
    if ( bool_of_uint256 (tmp147 = (W256.of_int 0)))
      {
      _264 <- (iszero usr_recursiveProofLengthInWords);
      usr_isValid <- (bit_and _264 usr_isValid);
      
      }
    
    else {
      _265 <- (usr_recursiveProofLengthInWords = _1);
      usr_isValid <- (bit_and _265 usr_isValid);
      _266 <- (usr_offset + _5);
      ...
      _273 <- (_272 = _271);
      usr_isValid <- (bit_and _273 usr_isValid);
      ...
      _283 <- (_282 = _281);
      usr_isValid <- (bit_and _283 usr_isValid);
    ...
    if ( bool_of_uint256 _286)
      {
      _287 <- STRING (*loadProof: Proof is invalid*);
      _288 <- (W256.of_int 27);
